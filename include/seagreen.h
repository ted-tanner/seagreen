        ...
        unsigned long long: ({                              \
                ...
                if (t == __cgn_curr_thread) {               \
                    ...
                    assert(0);                              \
                                                            ...
                                                            \
                (CGNThreadHandle_unsignedlonglong) {        \
                    .id = t->id,                            \
                };                                          \
            }),                                             \
        float: ({                                           \
